    ...
    func presentUpdateOnboarding(viewController: UIViewController, tintColor: UIColor) {
        ...
        let whatsNew = WhatsNew(
                ...
                items: [
                    WhatsNew.Item(
                        title: "Reminders",
                        subtitle: "Jotify now natively supports reminders! To set a reminder, tap into a note and click on the alarm icon on the top left hand corner. Once a note becomes a reminder, the border around the note will change color.",
                    ...
                    WhatsNew.Item(
                        title: "Bug Fixes",
                        subtitle: "There are a few regarding deleting notes and small fixes for settings on iPhone SE.",
