...
//    let writeNoteView = WriteNoteView()
    ...
    override func viewDidLoad() {
        ...
        editorView.setHTML(htmlContent)
    }
    ...
    func updateContent(index: Int, newContent: String, newDate: Double, htmlContent: String) {
        if isFiltering == false {
            notes[index].content = newContent
            notes[index].modifiedDate = newDate
            notes[index].htmlContent = htmlContent

        } else if isFiltering == true {
            filteredNotes[index].content = newContent
            filteredNotes[index].modifiedDate = newDate
            filteredNotes[index].htmlContent = htmlContent
        }
...
extension NoteDetailController: Aztec.TextViewFormattingDelegate {
...
extension NoteDetailController: Aztec.FormatBarDelegate {
...
extension FormattingIdentifier {
    ...
    private func gridicon(_ gridiconType: GridiconType) -> UIImage {
        let size = NoteDetailController.Constants.formatBarIconSize
